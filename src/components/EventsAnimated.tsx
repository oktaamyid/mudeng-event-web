    ...
    return (
        <section className="events section-spacing" id="events">
            <div className="container">
                ...
                <StaggerContainer className="flex flex-col gap-5" stagger={0.15}>
                    {events.map((evt, idx) => (
                        <StaggerItem key={idx}>
                            <div className="group relative h-[380px] sm:h-125 w-full overflow-hidden rounded-[20px] sm:rounded-[32px] bg-[#0a0a0a] md:h-162.5">
                                <img
                                ...
                                <div className="pointer-events-none absolute right-0 bottom-0 left-0 z-10 h-[280px] sm:h-87.5 bg-linear-to-b from-transparent via-black/95 to-black"></div>
                                ...
                                <div className="absolute top-4 left-4 z-30 max-w-[calc(100%-32px)] sm:max-w-112.5 sm:top-6 sm:left-6 md:top-9 md:left-9">
                                    ...
                                    <Link
                                        href={`/${evt.slug}`}
                                        scroll={true}
                                        className="font-body inline-flex h-10 sm:h-12.25 w-auto px-6 sm:w-50 items-center justify-center rounded-[30px] bg-[#F8F9FA] text-[14px] sm:text-[17px] leading-6.75 font-medium text-black shadow-[0px_6px_20px_rgba(0,0,0,0.1)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0px_8px_24px_rgba(0,0,0,0.15)] md:w-62.5"
                                    >
                                        Event details
                                    </Link>
                                </div>

                                <div className="absolute right-4 bottom-4 z-30 w-[calc(100%-32px)] sm:right-6 sm:bottom-6 sm:w-[calc(100%-48px)] md:right-9 md:bottom-9 md:w-167.5">
