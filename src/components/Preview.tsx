    ...
    return (
        <section className="preview section-spacing relative" id="preview">
            ...
            <div className="pointer-events-none absolute inset-0 z-20 overflow-visible lg:hidden">
                ...
                <FloatingBadge className="absolute top-[20px] right-[15%] flex h-7 rotate-[-3deg] items-center gap-1.5 rounded-full bg-white px-3 py-1.5 shadow-[0_8px_10px_rgba(26,26,26,0.08)]" delay={0.2} fromX={5} fromY={-20}>
                    <img src="/event/assets/icon-eyes.png" alt="" width="12" height="12" />
                    <span className="text-[12px] font-medium text-[#1A1A1A]/65">8600</span>
                </FloatingBadge>
                {/* 730 - upper left */}
                <FloatingBadge className="absolute top-[8%] left-[4%] flex h-7 rotate-[7deg] items-center gap-1.5 rounded-full bg-white px-3 py-1.5 shadow-[0_8px_10px_rgba(26,26,26,0.08)]" delay={0.4} fromX={-20} fromY={-8}>
                ...
                <FloatingBadge className="absolute top-[30%] right-[3%] flex h-7 rotate-[-5deg] items-center gap-1.5 rounded-full bg-white px-3 py-1.5 shadow-[0_8px_10px_rgba(26,26,26,0.08)]" delay={0.3} fromX={18} fromY={-5}>
                ...
                <FloatingBadge className="absolute bottom-[12%] left-[5%] flex h-7 rotate-[4deg] items-center gap-1.5 rounded-full bg-white px-3 py-1.5 shadow-[0_8px_10px_rgba(26,26,26,0.08)]" delay={0.55} fromX={-18} fromY={12}>
                ...
                <FloatingBadge className="absolute bottom-[10%] left-[45%] flex h-7 rotate-[-2deg] items-center gap-1.5 rounded-full bg-white px-3 py-1.5 shadow-[0_8px_10px_rgba(26,26,26,0.08)]" delay={0.45} fromX={8} fromY={15}>
                ...
                <FloatingBadge className="absolute bottom-[18%] right-[8%] flex h-7 rotate-[5deg] items-center gap-1.5 rounded-full bg-white px-3 py-1.5 shadow-[0_8px_10px_rgba(26,26,26,0.08)]" delay={0.5} fromX={15} fromY={10}>
            ...
            <div className="container">
                ...
                <div className="relative mx-auto" style={{ maxWidth: 960 }}>
                    ...
                    <div className="pointer-events-none absolute inset-0 z-20 hidden overflow-visible lg:block">
                        {/* 8600 - top center */}
                        <FloatingBadge className="absolute -top-[35px] left-[42%] flex h-8 rotate-[-2deg] items-center gap-2 rounded-full bg-white px-4 py-2 shadow-[0_12px_10px_rgba(26,26,26,0.1)]" delay={0.2} fromX={0} fromY={-20}>
                            <img src="/event/assets/icon-eyes.png" alt="" width="14" height="14" />
                            <span className="text-base font-medium text-[#1A1A1A]/65">8600</span>
                        </FloatingBadge>
                        {/* 730 - left side */}
                        <FloatingBadge className="absolute top-[30px] -left-[80px] flex h-8 rotate-[6deg] items-center gap-2 rounded-full bg-white px-4 py-2 shadow-[0_12px_10px_rgba(26,26,26,0.1)]" delay={0.35} fromX={-25} fromY={-10}>
                            <img src="/event/assets/icon-chat.png" alt="" width="14" height="14" />
                            <span className="text-base font-medium text-[#1A1A1A]/65">730</span>
                        </FloatingBadge>
                        {/* 1520 - right side */}
                        <FloatingBadge className="absolute top-[40px] -right-[60px] flex h-8 rotate-[-4deg] items-center gap-2 rounded-full bg-white px-4 py-2 shadow-[0_12px_10px_rgba(26,26,26,0.1)]" delay={0.3} fromX={25} fromY={-10}>
                            <img src="/event/assets/icon-heart.png" alt="" width="14" height="14" />
                            <span className="text-base font-medium text-[#1A1A1A]/65">1520</span>
                        </FloatingBadge>
                        {/* 2470 - lower left */}
                        <FloatingBadge className="absolute bottom-[-20px] left-[2%] flex h-8 rotate-[5deg] items-center gap-2 rounded-full bg-white px-4 py-2 shadow-[0_12px_10px_rgba(26,26,26,0.1)]" delay={0.5} fromX={-25} fromY={10}>
                            <img src="/event/assets/icon-jari.png" alt="" width="14" height="14" />
                            <span className="text-base font-medium text-[#1A1A1A]/65">2470</span>
                        </FloatingBadge>
                        {/* 410 - center bottom */}
                        <FloatingBadge className="absolute bottom-[-15px] left-[48%] flex h-8 rotate-[-3deg] items-center gap-2 rounded-full bg-white px-4 py-2 shadow-[0_12px_10px_rgba(26,26,26,0.1)]" delay={0.45} fromX={0} fromY={15}>
                            <img src="/event/assets/icon-share.png" alt="" width="14" height="14" />
                            <span className="text-base font-medium text-[#1A1A1A]/65">410</span>
                        </FloatingBadge>
                        {/* 1160 - right bottom */}
                        <FloatingBadge className="absolute -bottom-[20px] -right-[40px] flex h-8 rotate-[4deg] items-center gap-2 rounded-full bg-white px-4 py-2 shadow-[0_12px_10px_rgba(26,26,26,0.1)]" delay={0.55} fromX={25} fromY={10}>
