  ...
  return (
    ...
    >
      <div className="rounded-pill bg-white/75 p-1 backdrop-blur-md">
        <div className="bg-bg-main rounded-pill shadow-nav flex h-13.25 items-center gap-10 p-[5px_5px_5px_10px]">
          <Link href="/" className="flex items-center gap-2.5">
            <img
              className="h-10.5 w-10.5 rounded-full object-contain"
            ...
            />
            <img
              className="hidden h-3.5 w-auto object-contain sm:block"
          ...
          <div className="hidden items-center gap-4 md:flex">
            <Show when="signed-out">
              <Link href={ctaLink} className="bg-stat text-white rounded-pill font-nav shadow-nav flex items-center justify-center px-6 py-3 text-sm font-medium whitespace-nowrap transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:bg-brand">
                Daftar Sekarang
              </Link>
            </Show>
            <Show when="signed-in">
      ...
      >
        ...
        <Show when="signed-out">
          <div className="flex flex-col gap-2 mt-2">
            <Link href={ctaLink} className="bg-stat text-white rounded-pill font-nav px-6 py-3 text-center text-sm font-medium transition-colors hover:bg-brand">
              Daftar Sekarang
            </Link>
          </div>
        </Show>
