...
export default function EditEventPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    async function loadEvent() {
      ...
      if (res.success && res.data) {
        ...
        setEventData({
          ...
          overview: (res.data.overview as any) || { title: "Program overview", description: "" },
          process: (res.data.process as any) || { title: "Learning process", description: "" },
          result: (res.data.result as any) || { title: "Final result", description: "" },
  ...
  const handleDelete = async () => {
    if (!confirm("Are you sure you want to delete this event? This action cannot be undone and will delete all registrations.")) {
      return;
    }
  ...
  if (isLoading) {
    return <div className="flex justify-center py-20 text-muted-foreground">Loading event...</div>;
  }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-2 col-span-1 sm:col-span-2">
                ...
                <select
                  ...
                  onChange={(e: any) => setEventData({ ...eventData, status: e.target.value })}
